        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <p>New to the platform? Learn how to set up your account, navigate the dashboard, and make the most of our features.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <p>Manage your profile, update your password, and customize notification preferences to suit your needs.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
                    ...
                    <p>Find out how to upload, organize, and analyze your data efficiently with our tools.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="help-card">
